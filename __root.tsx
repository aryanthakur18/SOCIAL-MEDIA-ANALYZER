...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Analyze social media posts from PDFs and images and improve engagement." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Social Media Content Analyzer" },
      { property: "og:description", content: "Analyze social media posts from PDFs and images and improve engagement." },
